...
if file_name_a is not None:
     ...
     file_name_a.close()
     print(f"Файл {file_name} закрито.")
#Приходько Mарія КН-32/2
#Відкриття файлу
file_name_a = openFile("Python.txt", "a")
#Запис у файл
if file_name_a is not None:
     file_name_a.write("Приходько Марія КН-32\n")
     file_name_a.write("Це означає, що тип даних визначається уже під час виконання програми, і не завжди обов'язково його вказувати в коді.\n")
     file_name_a.write("Останнє питання: Які існують вбудовані функції для роботи з словниками? \n")
     file_name_a.close()
     print(f"Файл {file_name} закрито.")